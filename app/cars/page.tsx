    ...
    <div className="min-h-screen bg-zinc-50 py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-white p-6 rounded-3xl border border-zinc-200 shadow-sm">
          <div>
            ...
            <p className="text-xs sm:text-sm text-zinc-500 mt-1">
              Showing <span className="font-bold text-black">{filteredCars.length}</span> verified cars ready for delivery
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          {/* Filters Sidebar */}
          <div className="lg:col-span-3 bg-white p-6 rounded-3xl border border-zinc-200 shadow-sm space-y-6">
            <div className="flex items-center justify-between border-b border-zinc-100 pb-3">
              ...
              <button
                ...
                className="flex items-center gap-1 text-[11px] font-semibold text-zinc-400 hover:text-black transition-colors"
              >
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full text-xs font-semibold pl-9 pr-3 py-2.5 rounded-xl border border-zinc-200 focus:outline-none focus:border-black"
                />
              </div>
            </div>
          ...
          <div className="lg:col-span-9 space-y-6">
            {filteredCars.length === 0 ? (
              <div className="text-center py-20 bg-white rounded-3xl border border-zinc-200 p-8 space-y-4">
                <div className="h-16 w-16 mx-auto rounded-full bg-zinc-100 flex items-center justify-center text-zinc-400">
