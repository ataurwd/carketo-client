...
export default function AdminAuditLogsPage() {
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      {/* SEARCH BAR */}
      <div className="bg-zinc-900/80 backdrop-blur-sm p-4 sm:p-5 rounded-3xl border border-zinc-800 shadow-sm">
                        ...
                        <td className="py-4 px-4 text-right">
                          {log.details ? (
                            <button
                              ...
                              className="inline-flex items-center gap-1 text-[11px] font-bold text-orange-400 hover:text-orange-300 transition-colors"
                            >
